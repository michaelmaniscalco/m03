...
//==============================================================================
inline auto maniscalco::m03_context_array::operator []
(
    std::size_t index
) -> entry_type &
{
...
//==============================================================================
inline auto maniscalco::m03_context_array::begin
(
) -> iterator
{
    return data_.get();
...
//==============================================================================
inline auto maniscalco::m03_context_array::end
(
) -> iterator
{
...
//==============================================================================
inline void maniscalco::m03_context_array::entry_type::set
(
    std::uint32_t size,
    type contextType
)
...
//==============================================================================
inline auto maniscalco::m03_context_array::entry_type::set_type
(
    type contextType
) -> type
{
...
//==============================================================================
inline maniscalco::m03_context_array::iterator::iterator
(
    entry_type * entry
):
    entry_(entry)
...
//==============================================================================
inline auto maniscalco::m03_context_array::iterator::operator ++ 
(
    int
) -> iterator
{
...
//==============================================================================
inline bool maniscalco::m03_context_array::iterator::operator !=
(
    iterator const & other
) const
{
...
//==============================================================================
inline maniscalco::m03_context_array::const_iterator::const_iterator
(
    iterator other
):
    entry_(&*other)
...
//==============================================================================
inline auto maniscalco::m03_context_array::const_iterator::operator ++ 
(
    int
) -> const_iterator
{
...
//==============================================================================
inline bool maniscalco::m03_context_array::const_iterator::operator !=
(
    const_iterator const & other
) const
{
