...
namespace
{
    ...
    )
    {
        ...
        maniscalco::m03_encode(begin, end, sentinelIndex);
    ...
    {
        std::cout << "m03 - high performance BWT compressor.  Author: M.A. Maniscalco (2000 - 2018)" << std::endl;
    }
    ...
    {
        std::cout << "Usage: m03 [e|d] inputFile outputFile threadCount" << std::endl;
        return 0;
    }
}
